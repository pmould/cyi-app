...
$.getJSON("http://localhost:8080/int_sms/webapi/translation/getdetails", function(response){
 $(function(){
    ...
    var row1 = {};
        ...
        formOutput += "<div class='ui-front'></label>Client<label><input name='client_name' type='text' value='"+tr.client_name+"'></div>";
        ...
        formOutput += "<div><label>Language</label><input name='lang' value='"+tr.lang+"'></div>";
        formOutput += "<div><label>Notoring Required?(Y/N)</label><input name='notoring_rqd' value='"+tr.notoring_rqd+"'></div>";
